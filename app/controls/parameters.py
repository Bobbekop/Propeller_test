...
def parameter_controls():
    ...
    with propeller_parameters:
        ...
        tip_size=st.number_input("Tip Size",min_value=0.01,value=0.01,max_value=15.0,step=0.1,format="%.1f")   
    ...
    with hub_and_counterweight_parameters:
       ...
       with col3:
           counterweight_length=st.number_input("Counterweight Length", min_value=10.0,value=17.0,max_value=50.0,step=0.1,format="%.1f")
